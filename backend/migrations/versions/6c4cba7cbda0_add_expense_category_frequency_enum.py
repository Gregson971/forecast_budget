...
def upgrade() -> None:
    ...
    op.alter_column('expenses', 'category',
               ...
               type_=sa.Enum('FOOD', 'TRANSPORT', 'ENTERTAINMENT', 'SHOPPING', 'HEALTH', 'HOUSING', 'UTILITIES', 'INSURANCE', 'SUBSCRIPTIONS', 'OTHER', name='expensecategory'),
               nullable=False)
    op.alter_column('expenses', 'frequency',
               existing_type=sa.VARCHAR(),
...
def downgrade() -> None:
    ...
    op.alter_column('expenses', 'frequency',
               ...
               existing_nullable=True)
    op.alter_column('expenses', 'category',
               existing_type=sa.Enum('FOOD', 'TRANSPORT', 'ENTERTAINMENT', 'SHOPPING', 'HEALTH', 'HOUSING', 'UTILITIES', 'INSURANCE', 'SUBSCRIPTIONS', 'OTHER', name='expensecategory'),
               type_=sa.VARCHAR(),
               nullable=True)
    # ### end Alembic commands ###
